...
def src_build():
    ...
    core_files=[
        ...
        {'name':'methods-database-set','file':source_dir+'/ddb/methods/table/data/database/set.py'},
        {'name':'methods-database-use','file':source_dir+'/ddb/methods/table/data/database/use.py'},
