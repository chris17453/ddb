...
def src_build():
    ...
    core_files=[
        ...
        {'name':'methods-records-show-columns','file':source_dir+'/ddb/methods/record_show_columns.py'},
        {'name':'methods-records-show-tables','file':source_dir+'/ddb/methods/record_show_tables.py'},
        {'name':'methods-records-update','file':source_dir+'/ddb/methods/record_update.py'},
        {'name':'methods-database-set','file':source_dir+'/ddb/methods/database_set.py'},
        {'name':'methods-database-use','file':source_dir+'/ddb/methods/database_se.py'},
