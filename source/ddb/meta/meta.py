...
def convert_to_class(o):
    ...
    if o['mode']=='Show_Columns': return show_columns(o)
    elif o['mode']=='Show_Tables': return show_tables(o)
    elif o['mode']=='Show_Variables': return show_variables(o)
    elif o['mode']=='Select': return select(o)
    elif o['mode']=='Set': return set(o)
    elif o['mode']=='Create_Procedure': return create_procedure(o)
    ...
    elif o['mode']=='Show_Output_Modules': return show_output_modules(o)
    ...
    elif o['mode']=='Use_Table': return use_table(o)
    elif o['mode']=='Drop_Table': return drop_table(o)
    elif o['mode']=='Create_Table': return create_table(o)
    elif o['mode']=='Update_Table': return update_table(o)
    elif o['mode']=='Describe_Table': return describe_table(o)
