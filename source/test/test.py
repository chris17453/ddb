...
class test_engine(unittest.TestCase):
    ...
    def test_upsert(self):
        ...
        try:
            ...
            results = engine.query("upsert into {} ('id','first_name','last_name','email','gender','ip_address') values (1001,test_name,test_lname,'bop@bob.com','m','0.0.0.0') ON DUPLICATE KEY id UPDATE id='10000' ".format(self.table_name))
            self.assertEqual(True, results.success)
