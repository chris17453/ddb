            ...
            for block in blocks:
                if in_block:
                    ...
                    if text[string_index:string_index+comparitor_len]==comparitor:
                        ...
                        in_block=None
                        if word:
                            tokens.append({'block_left':block_left,'block_right':block_right,'data':word)
                            word=None
                    ...
                    comparitor=block[0]
                    if text[string_index:string_index+len(comparitor)]==comparitor:
