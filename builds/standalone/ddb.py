...
language = {
    "commands": [
        {
            ...
            "segments": [
                {
                    "data": [{"signature": ["show", "columns"]}],
                    "name": ["show", "columns"],
                },
                {
                    "data": [
                        {"signature": ["from", "{table}"]},
                        {"signature": ["from", "{database}", ".", "{table}"]},
                    ],
                    "name": "from",
                },
            ],
        ...
        },
        {
            ...
            "segments": [
                ...
                },
                {
                    ...
                    "data": [
                        {"signature": ["{column}"]},
                        {"signature": ["{column}", "as", "{display}"]},
                        {"signature": ["{function}", "(", ")"]},
                        {"signature": ["{function}", "(", "{argument1}", ")"]},
                        {
                            "signature": [
                                "{function}",
                                "(",
                ...
                },
                {
                    "data": [
                        {"signature": ["from", "{table}"]},
                        {"signature": ["from", "{table}", "as", "{display}"]},
                        {"signature": ["from", "{database}", ".", "{table}"]},
                        {
                            "signature": [
                                "from",
                ...
                {
                    "data": [
                        {"signature": ["left join", "{table}"]},
                        {"signature": ["left join", "{table}", "as", "{display}"]},
                    ],
                    "depends_on": "from",
                    "name": "left join",
                    "optional": True,
                ...
                {
                    "data": [
                        {"signature": ["right join", "{table}"]},
                        {"signature": ["right join", "{table}", "as", "{display}"]},
                    ],
                    "depends_on": "from",
                    "name": "right join",
                    "optional": True,
                ...
                {
                    "data": [
                        {"signature": ["full join", "{table}"]},
                        {"signature": ["full join", "{table}", "as", "{display}"]},
                    ],
                    "depends_on": "from",
                    "name": "full join",
                    "optional": True,
                ...
                },
                {
                    ...
                    "data": [
                        {"signature": ["{column}"]},
                        {"signature": ["{column}", "asc"], "vars": {"direction": 1}},
                        {"signature": ["{column}", "desc"], "vars": {"direction": -1}},
                    ],
                    "name": "order by",
                ...
                {
                    "data": [
                        {"signature": ["limit", "{length}"]},
                        {"signature": ["limit", "{start}", ",", "{length}"]},
                    ],
                    "name": "limit",
                    "optional": True,
                    "specs": {
        ...
        },
        {
            ...
            "segments": [
                {
                    "arguments": None,
                    "data": [{"signature": ["create", "procedure", "("]}],
                    "dispose": True,
                    "name": ["create", "procedure"],
                    "optional": False,
                },
        ...
        },
        {
            ...
            "segments": [
                {
                    "data": [{"signature": ["delimiter", "{delimiter}"]}],
                    "name": "delimiter",
                }
            ],
        },
        ...
        {
            "name": "begin",
            "segments": [{"data": [{"signature": ["begin"]}], "name": "begin"}],
        },
        {
            "name": "commit",
            "segments": [{"data": [{"signature": ["commit"]}], "name": "commit"}],
        },
        {
            "name": "rollback",
            "segments": [{"data": [{"signature": ["rollback"]}], "name": "rollback"}],
        },
        {
            "name": "show output modules",
            "segments": [
                {
                    "data": [{"signature": ["show", "output", "modules"]}],
                    "name": "show output modules",
                }
            ],
        },
        {
            "name": "delete",
            "segments": [
                {"data": [{"signature": ["delete"]}], "name": "delete"},
                {"data": [{"signature": ["from", "{table}"]}], "name": "from"},
                {
                    "data": [{"signature": ["where", "{e1}", "$operators:c", "{e2}"]}],
                    "name": "where",
                    "optional": True,
        ...
        },
        {
            "name": "insert",
            "segments": [
                {"data": [{"signature": ["insert"]}], "name": "insert"},
                {
                    "data": [
                        {"signature": ["into", "{table}"]},
                        {"signature": ["into", "{database}", ".", "{table}"]},
                    ],
                    "name": "into",
                },
                {"data": [{"signature": ["("]}], "dispose": True, "name": "("},
                {
                    "arguments": 0,
                    "data": [{"signature": ["{column}"]}],
                    "name": "columns",
        ...
        },
        {
            ...
            "segments": [
                {
                    "data": [
                        {"signature": ["update", "{table}"]},
                        {"signature": ["update", "{database}", ".", "{table}"]},
                    ],
                    "name": "update",
                },
                {"name": "set header", "data": [{"signature": ["set"]}]},
                {
                    "arguments": 0,
                    "data": [{"signature": ["{column}", "=", "{expression}"]}],
                    "name": "set",
                    "depends_on": "set header",
                },
                {
        ...
        },
        {
            "name": "upsert",
            "segments": [
                {"data": [{"signature": ["upsert"]}], "name": "upsert"},
                {
                    "data": [
                        {"signature": ["into", "{table}"]},
                        {"signature": ["into", "{database}", ".", "{table}"]},
        ...
        {
            "name": "use",
            "segments": [{"data": [{"signature": ["use", "{table}"]}], "name": "use"}],
        },
        {
            "name": "drop",
            "segments": [
                {
                    "data": [
                        {"signature": ["drop", "table", "{table}"]},
                        {"signature": ["drop", "table", "{database}", ".", "{table}"]},
                    ],
                    "name": "drop",
                }
            ],
            ...
            "segments": [
                ...
                },
                {
                    "data": [
                        ...
                        {"signature": ["table", "{database}", ".", "{table}"]},
                    ],
                    "name": "table",
                    "optional": False,
                    "type": "single",
                ...
                },
                {
                    ...
                    "name": "delimiter",
                    "optional": True,
                    "specs": {"field": {"default": ",", "type": "char"}},
                    "type": "single",
                },
                {
                    "data": [{"signature": ["whitespace", "=", "{whitespace}"]}],
                    "name": "whitespace",
                    "optional": True,
                ...
                {
                    "data": [{"signature": ["comments", "=", "{comments}"]}],
                    "name": "comments",
                    "optional": True,
                ...
                {
                    "data": [
                        {"signature": ["data_starts_on", "=", "{data_starts_on}"]}
                    ],
                    "name": "data_starts_on",
                    "optional": True,
                    "specs": {"data_starts_on": {"default": 1, "type": "int"}},
                    "type": "single",
                },
            ],
        },
        {
            ...
            "segments": [
                {
                    "data": [{"signature": ["update", "table", "{table}"]}],
                    "name": "update",
                },
                {
                    "data": [{"signature": ["("]}],
                ...
                {
                    "data": [{"signature": ["delimiter", "=", "{field}"]}],
                    "name": "delimiter",
                    "optional": True,
                    "specs": {"field": {"default": ",", "type": "char"}},
                },
                ...
                {
                    "data": [{"signature": ["errors", "=", "{whitespace}"]}],
                    "name": "errors",
                    "optional": True,
                    "specs": {"errors": {"type": "bool"}},
                },
        ...
        },
        {
            ...
            "segments": [
                {
                    "data": [
                        {"signature": ["describe", "table", "{table}"]},
                        {
                            "signature": [
                                "describe",
                                "table",
    ...
    "functions": [
        {"arguments": None, "name": "database"},
        {"arguments": None, "name": "row_number"},
        {"arguments": [{"name": "where", "required": True}], "name": "count"},
        {"arguments": [{"name": "column", "required": True}], "name": "sum"},
        {"arguments": None, "name": "version"},
        {"arguments": [{"name": "column", "required": True}], "name": "upper"},
        {"arguments": [{"name": "column", "required": True}], "name": "lower"},
        {
            "arguments": [
            ...
            while True == in_argument:
                ...
                if None == match:
                    ...
                    if "vars" in signature:
                        for var_name in signature["vars"]:
                            self.info(
                                "var",
                                "'{0}'='{1}'".format(
                                    var_name, signature["vars"][var_name]
                                ),
                            )
                    ...
                    for w_index in range(0, len(match)):
                        word = match[w_index]
                        try:
                            computed = self.get_argument(
                                word, segment, tokens, token_index, w_index
                            )
                    ...
                    if arguments != 0:
                        ...
                        if argument_index >= arguments:
                            ...
                            if True == flags.store_array:
                                ...
                                query_object[curent_object["mode"]].append(
                                    {curent_object["mode"]: curent_object["arguments"]}
                                )
                            else:
                                if None == flags.parent:
                                    if flags.meta_type == "single":
                                        for flags.arg_key in curent_object["arguments"]:
                                            query_object[flags.arg_key] = curent_object[
                                                "arguments"
                                            ][flags.arg_key]
                                    else:
                                        query_object[
                                    ...
                                    query_object[flags.parent].append(
                                        {
                                            curent_object["mode"]: curent_object[
                                                "arguments"
                                            ]
                                        }
                                    )
                            ...
                            if None != jump:
                                ...
                                for ts in command["segments"]:
                                    if ts["name"] == jump:
                                        self.info(
                                            "Jumping from ", segment_index, tsi + 1
                                        )
                                        segment_index = tsi + 1
                                        break
                                    tsi += 1
                        ...
                        if len(tokens) <= token_index:
                            ...
                            if True == flags.store_array:
                                ...
                                if None == flags.parent:
                                    query_object[curent_object["mode"]] = curent_object[
                                        "arguments"
                                    ]
                                    self.info("NO APPEND")
                                else:
...
class tokenizer:
    def chomp(
        self, text, discard_delimiters=False, discard_whitespace=True, debug=None
    ):
        self.debug_on = None
        tokens = []
        text = text.strip()
                ...
                if (fragment == d and fragment is not None) or c >= text_length - 1:
                    ...
                    if c - word_start > 0:
                        ...
                        if word_end >= text_length:
                            self.info(
                                "word ends on last character", word_end, text_length
                            )
                        ...
                        if block is not None:
                            ...
                            block_type = block[2]
                            block = None
                            not_delimiter = not_delimiter[
                                len(block_left) : -len(block_right)
                            ]
                        else:
                            block_left = None
                            block_right = None
    ...
    def save(self):
        ...
        if None == self.data.config:
            self.data.config = os.path.join(
                home, "{0}.{1}.create.sql".format(self.data.database, self.data.name)
            )
...
class database:
    ...
    def temp_table(self, name=None, columns=[], delimiter=None):
        ...
        return table(
            name=name,
            columns=columns,
            database=self.get_curent_database(),
    ...
    def drop_table(self, table_name, database_name=None):
        ...
        for index in range(0, len(self.tables)):
            if (
                self.tables[index].data.name == table_name
                and self.tables[index].data.database == database_name
            ):
    ...
    def evaluate_single_match(self, context, test, row, table):
        ...
        for column in table.columns:
            if column.data.name == test["e1"]:
                ...
                compare1 = row[
                    index
                ]  # table.ordinals[].get_data_from_column(column,row)
        ...
        if comparitor == "=" or comparitor == "is":
            ...
            if True == compare1_is_column and True == compare2_is_column:
                raise Exception(
                    "Where invalid {0}, like cant be between 2 columns".format(test)
                )
...
class engine:
    ...
    def query(self, sql_query):
        ...
        for query_object in parser.query_objects:
            ...
            if mode == "select":
                ...
                self.results = method_system_show_columns(
                    self, self.database, query_object
                )
    ...
    def svn_checkout_file(self, table):
        ...
        if table.data.repo_type == "svn":
            cmd = [
                ...
                "--no-auth-cache",
                "--username",
                "{0}".format(table.data.repo_user),
                "--password",
                "{0}".format(table.data.repo_password),
                "co",
                table.data.repo_url,
                table.data.repo_dir,
                "--depth",
    ...
    def get_data_file(self, table, prefix="ddb_"):
        ...
        if data_file not in self.internal["TEMP_FILES"]:
            ...
            temp_data_file = create_temporary_copy(
                data_file, self.system["UUID"], prefix
            )
            self.internal["TEMP_FILES"][data_file] = {
                "origin": data_file,
                "temp_source": temp_data_file,
                "written": None,
                "table": table,
            }
    ...
    def autocommit_write(self, table, dest_file):
        ...
        if table_key in self.internal["TEMP_FILES"]:
            ...
            if (
                dest_file
                and dest_file != self.internal["TEMP_FILES"][table_key]["temp_source"]
            ):
    ...
    if try_match:
            ...
            if line_cleaned[0] in table.delimiters.comment:
                ...
                if table.data.strict_columns == True:
                    if cur_column_len != column_count:
                        if cur_column_len > column_count:
                            err = "Table {2}: Line #{0}, {1} extra Column(s)".format(
                                line_number,
                                cur_column_len - column_count,
                                table.data.name,
                            )
                        else:
                            err = "Table {2}: Line #{0}, missing {1} Column(s)".format(
                                line_number,
                                column_count - cur_column_len,
                                table.data.name,
                            )
        ...
        if "where" not in query_object["meta"]:
            ...
            if line_type == context.data_type.DATA:
                match_results = context.match.evaluate_match(
                    context, query_object, line_data
                )
            else:
                match_results = False
    ...
    try:
        ...
        with open(temp_data_file, "r") as content_file:
            temp_file = tempfile.NamedTemporaryFile(
                mode="w", prefix="DST_DELETE", delete=False
            )
...
def method_insert(context, query_object):
    ...
    with open(temp_data_file, "r") as content_file:
        with tempfile.NamedTemporaryFile(
            mode="w", prefix="DST_INSERT", delete=False
        ) as temp_file:
            for line in content_file:
                processed_line = process_line(
                    context,
...
def create_single(context, query_object, temp_file, requires_new_line):
    ...
    if len(query_object["meta"]["columns"]) != query_object["table"].column_count():
        context.add_error(
            "Cannot insert, column count does not match table column count"
        )
    else:
        if len(query_object["meta"]["values"]) != query_object["table"].column_count():
            context.add_error(
                "Cannot insert, column value count does not match table column count"
            )
        else:
            new_line = ""
            err = False
            for c in range(0, len(query_object["meta"]["columns"])):
                ...
                for c2 in range(0, len(query_object["meta"]["columns"])):
                    if query_object["meta"]["columns"][c2]["column"] == column_name:
                        ...
                        if c > 0:
                            new_line += "{0}".format(
                                query_object["table"].delimiters.field
                            )
                        new_line += "{0}".format(
                            query_object["meta"]["values"][c2]["value"]
                        )
                if False == found:
                    context.add_error(
                        "Cannot insert, column in query not found in table: {0}".format(
                            column_name
                        )
                    )
                    err = True
...
def method_select(context, query_object, parser):
    ...
    return query_results(
        success=True, data=temp_table, total_data_length=all_records_count
    )
        ...
        with open(temp_data_file, "r") as content_file:
            for line in content_file:
                ...
                if None != processed_line["data"]:
                    restructured_line = process_select_row(
                        context, query_object, processed_line
                    )
...
def compare_data(context, data1, data2):
    ...
    if (not isinstance(data1, dict)) or (not isinstance(data2, dict)):
        ...
        if not (
            len(shared_keys) == len(data1.keys())
            and len(shared_keys) == len(data2.keys())
        ):
            return None
...
def update_single(context, query_object, temp_file, requires_new_line, processed_line):
    ...
    for c2 in range(0, len(query_object["meta"]["set"])):
        ...
        if None == query_object["table"].get_column_by_name(column_name):
            context.add_error(
                "column in update statement does not exist in table: {0}".format(
                    column_name
                )
            )
            err = True
...
def method_update(context, query_object):
    try:
        ...
        with open(temp_data_file, "r") as content_file:
            with tempfile.NamedTemporaryFile(
                mode="w", prefix="UPDATE", delete=False
            ) as temp_file:
                for line in content_file:
                    processed_line = process_line(
                        context,
                    ...
                    line_number += 1
                    if True == processed_line["match"]:
                        results = update_single(
                            context, query_object, temp_file, False, processed_line
                        )
                        if True == results["success"]:
                            diff.append(results["line"])
                            affected_rows += 1
...
def method_upsert(context, query_object):
    try:
        ...
        with open(temp_data_file, "r") as content_file:
            with tempfile.NamedTemporaryFile(
                mode="w", prefix="UPSERT", delete=False
            ) as temp_file:
                for line in content_file:
                    processed_line = process_line(
                        context,
...
def method_create_table(context, query_object):
    ...
    try:
        ...
        if "repo_type" in query_object["meta"]:
            ...
            repo_dir = None
            repo_file = None
        results = context.database.create_table(
...
def method_describe_table(context, query_object):
    ...
    try:
        ...
        temp_table.append_data(
            {
                "data": ["active", target_table.active],
                "type": context.data_type.DATA,
                "error": None,
            }
        )
        temp_table.append_data(
            {
                "data": ["table_name", target_table.data.name],
                "type": context.data_type.DATA,
                "error": None,
            }
        )
        temp_table.append_data(
            {
                "data": ["database", target_table.data.database],
                "type": context.data_type.DATA,
                "error": None,
            }
        )
        temp_table.append_data(
            {
                "data": ["data_file", target_table.data.path],
                "type": context.data_type.DATA,
                "error": None,
            }
        )
        temp_table.append_data(
            {
                "data": ["fifo", target_table.data.fifo],
                "type": context.data_type.DATA,
                "error": None,
            }
        )
        temp_table.append_data(
            {
                "data": ["type", target_table.data.type],
                "type": context.data_type.DATA,
                "error": None,
            }
        )
        temp_table.append_data(
            {
                "data": ["config_file", target_table.data.config],
                "type": context.data_type.DATA,
                "error": None,
            }
        )
        temp_table.append_data(
            {
                "data": ["data_starts_on", target_table.data.starts_on_line],
                "type": context.data_type.DATA,
                "error": None,
            }
        )
        temp_table.append_data(
            {
                "data": ["field_delimiter", target_table.delimiters.field],
                "type": context.data_type.DATA,
                "error": None,
            }
        )
        temp_table.append_data(
            {
                "data": ["comments_visible", target_table.visible.comments],
                "type": context.data_type.DATA,
                "error": None,
            }
        )
        temp_table.append_data(
            {
                "data": ["errors_visible", target_table.visible.errors],
                "type": context.data_type.DATA,
                "error": None,
            }
        )
        temp_table.append_data(
            {
                "data": ["whitespace_visible", target_table.visible.whitespace],
                "type": context.data_type.DATA,
                "error": None,
            }
        )
        temp_table.append_data(
            {
                "data": ["strict_columns", target_table.data.strict_columns],
                "type": context.data_type.DATA,
                "error": None,
            }
        )
        temp_table.append_data(
            {
                "data": ["repo_type", target_table.data.repo_type],
                "type": context.data_type.DATA,
                "error": None,
            }
        )
        temp_table.append_data(
            {
                "data": ["repo_url", target_table.data.repo_url],
                "type": context.data_type.DATA,
                "error": None,
            }
        )
        temp_table.append_data(
            {
                "data": ["repo_dir", target_table.data.repo_dir],
                "type": context.data_type.DATA,
                "error": None,
            }
        )
        temp_table.append_data(
            {
                "data": ["repo_file", target_table.data.repo_file],
                "type": context.data_type.DATA,
                "error": None,
            }
        )
        temp_table.append_data(
            {
                "data": ["user", target_table.data.repo_user],
                "type": context.data_type.DATA,
                "error": None,
            }
        )
        temp_table.append_data(
            {
                "data": ["password", target_table.data.repo_password],
                "type": context.data_type.DATA,
                "error": None,
            }
        )
...
def method_drop_table(context, query_object):
    ...
    try:
        ...
        if "database" in query_object["meta"]["drop"]:
            ...
            context.info("Using curent database context")
            database_name = context.database.get_curent_database()
        results = context.database.drop_table(
        ...
        for item in query_object["meta"]["set"]:
            ...
            if var_type == "system":
                if variable in context.system:
                    ...
                    raise Exception(
                        "Cannot set {0}, not a system variable".format(variable)
                    )
            elif var_type == "user":
        ...
        if context.internal["IN_TRANSACTION"] == 1:
            ...
            for table_key in context.internal["TEMP_FILES"]:
                ...
                if None == tmp["written"]:
                    ...
                    swap_files(
                        tmp["origin"], tmp["temp_source"], context.system["UUID"]
                    )
...
def method_system_show_columns(context, database, query_object):
    try:
        if "database" in query_object["meta"]["from"]:
            ...
            database_name = context.database.get_curent_database()
        table = database.get(
            query_object["meta"]["from"]["table"], database_name=database_name
        )
        temp_table = database.temp_table(columns=["database", "table", "column"])
        if table:
            for c in table.columns:
                columns = {
                    "data": [table.data.database, table.data.name, c.data.name],
                    "type": context.data_type.DATA,
                    "error": None,
                }
...
def method_system_show_tables(context, database):
    try:
        ...
        for t in database.tables:
            ...
            temp_table.append_data(
                {"data": columns, "type": context.data_type.DATA, "error": None}
            )
        return query_results(success=True, data=temp_table)
    except Exception as ex:
        return query_results(success=False, error=ex)
...
def method_system_show_variables(context, query_object):
    ...
    try:
        ...
        for c in context.system:
            columns = {
                "data": ["system", c, context.system[c]],
                "type": context.data_type.DATA,
                "error": None,
            }
            temp_table.append_data(columns)
...
def method_system_show_output_modules(context, query_object):
    try:
        temp_table = context.database.temp_table(
            columns=["output_module", "output_style"]
        )
...
class lock:
        ...
        if os.path.exists(lock_path):
            with open(lock_path, "r") as lockfile:
                try:
                    ...
                    file_lock_time = datetime.datetime.strptime(
    ...
    def release(path):
        ...
        if os.path.exists(lock_path) == False:
            raise Exception(
                "Lockfile cannot be removed, it doesnt exist. {0}".format(lock_path)
            )
        os.remove(lock_path)
        if os.path.exists(lock_path):
    ...
    def aquire(path, key_uuid):
        ...
        while 1:
            ...
            lock.info(
                "Lock",
                "File locked, waiting till file timeout, or max lock retry time, {0},{1},{2}".format(
                    path, lock_time, lock_status
                ),
            )
            ...
            if lock_time > lock.max_lock_time:
                ...
                raise Exception(
                    "Cannot aquire lock, max timeout of {0} seconds reached. Aproxomatly '{1}' cycles".format(
                        lock.max_lock_time, lock_cycle
                    )
                )
        lock_path = lock.get_lock_filename(path)
...
def swap_files(path, temp, key_uuid):
    ...
    try:
        if lock.LOCK_OWNER != lock.is_locked(path, key_uuid):
            raise Exception(
                "Cannot swap files, expected lock. Didnt find one {0}".format(path)
            )
...
class output_factory:
    def __init__(
        ...
        query_results,
        output="term",
        output_style="flextable",
        output_file=None,
        output_stream="STDIO",
        color=True,
    ):  # style single double rst
        ...
        if "bash" == mode:
            ...
            self.output = self.format_term(
                query_results, output_style, output_stream=output_stream, color=color
            )
        elif "raw" == mode:
            ...
            self.output = "User Time:Start:{0}, End:{1}, Elapsed:{2}".format(
                query_results.start_time, query_results.end_time, query_results.time
            )
            self.output += "Wall Time:Start:{0}, End:{1}, Elapsed:{2}".format(
                query_results.wall_start,
                query_results.wall_end,
                query_results.wall_time,
            )  # default
        else:
            self.output = self.format_term(query_results)

    def format_term(
        self, query_results, output_style=None, output_stream=None, color=True
    ):
        ...
        if True == query_results.success:
            if res:
                res.append(
                    "executed in {0:.6f}, {1} rows returned".format(
                        query_results.time, query_results.data_length
                    )
                )
            else:
                print(
    ...
    def format_bash(self, query_results):
        ...
        for row in data:
            for column_index in range(0, len(query_results.columns)):
                print(
                    '{0}_data[{1}][{2}]="{3}"'.format(
                        name, row_index, column_index, row["data"][column_index]
                    )
                )
            row_index += 1
        return ""
...
class flextable:
    ...
    class color:
        def __init__(
            ...
            if None != default:
                ...
                if None == bold:
                    bold = default.bold
            self.color = flextable.colors(
                foreground=foreground, background=background, dim=dim, bold=bold
            )
            if None != text:
                if text.isspace():
                    text = None
    ...
    class characters:
        ...
        class char_header:
            def __init__(self, default=None, style="rst"):
                ...
                self.right = flextable.color(
                    text=r, default=default, foreground="White"
                )
                self.center = flextable.color(
                    text=c, default=default, foreground="green"
                )
        ...
        class char_footer:
            def __init__(self, default=None, style="rst"):
                if style == "single":
                    ...
                    c = u" "
                    r = None
                self.left = flextable.color(
                    text=l, default=default, foreground="White"
                )  # ╡
                self.right = flextable.color(
                    text=r, default=default, foreground="White"
                )  # ╞
    ...
    def calculate_limits(self):
        ...
        if data_column_count == 0:
            ...
            if self.column_width != -1:
                self.column_character_width = int(
                    (int(self.column_width) - 1 - pad) / data_column_count
                )
                if self.column_character_width < tty_min_column_width:
                    self.column_character_width = tty_min_column_width
        self.total_width = (
            self.column_character_width * data_column_count + data_column_count - 1
        )
    ...
    def build_header(self, footer=False, mid=False):
        ...
        if None != self.columns:
            ...
            for c in self.columns:
                ...
                column_display += column.center.render(
                    use_color=self.render_color,
                    text=c,
                    length=self.column_character_width - column_pad,
                )
                if column.right.text:
                ...
                if index < len(self.columns) - 1:
                    if len("{0}".format(c)) > self.column_character_width - 2:
                        header += base.center.render(
                            use_color=self.render_color,
                            override=self.style.color.overflow,
                        )
                    else:
        ...
        if True == isinstance(buffer, list):
            for line in buffer:
                ...
                if self.data_type.DATA == line["type"]:
                    for c in line["data"]:
                        columns += self.style.color.data.render(
                            c,
                            use_color=self.render_color,
                            length=self.column_character_width,
                        )
                    ...
                    if data_len < self.column_count:
                        ...
                        for c in range(data_len, self.column_count):
                            columns += self.style.color.comment.render(
                                "",
                                use_color=self.render_color,
                                length=self.column_character_width,
                            )
                            columns += self.style.characters.walls.right.render(
                                use_color=self.render_color,
                                override=self.style.color.error,
                            )
                elif (
                    self.data_type.COMMENT == line["type"]
                    or self.data_type.WHITESPACE == line["type"]
                ):
                    left = self.style.characters.walls.left.render(
                        use_color=self.render_color
                    )
                    center = self.style.color.comment.render(
                        line["raw"],
                        use_color=self.render_color,
                    ...
                    columns = u"{0}{1}{2}".format(left, center, right)
                elif self.data_type.ERROR == line["type"]:
                    left = self.style.characters.walls.left.render(
                        use_color=self.render_color
                    )
                    center = self.style.color.error.render(
                        line["raw"],
                        use_color=self.render_color,
                        length=self.total_width,
                    )
    ...
    def build_row_seperator(self, header=None):
        ...
        for i in range(0, self.column_count):
            row += self.style.characters.rst.row.render(
                "",
                fill_character=char,
                use_color=self.render_color,
                length=self.column_character_width,
    ...
    def format(self):
        ...
        for row in rows:
            ...
            if self.header_every > 0:
                if (
                    index % self.header_every == 0
                    and len(buffer) - index > self.header_every
                ):
        ...
        while fragment != None:
            ...
            if parent_fragment:
                if parent_fragment["type"] != "list":
                    arr_depth = 0
                if (
                    parent_fragment["type"] == "list"
                    and fragment["type"] == "list"
                    and last_fragment["depth"] < fragment["depth"]
                ):
                    arr_depth += 1
                if (
                    parent_fragment["type"] == "list"
            ...
            if fragment["type"] == "class":
                ...
                line += "{0}: ".format(
                    fragment["key"]
                )  # +""+str(arr_depth)+'-'+str(len(path))+"-"+str(indent)
            ...
            if is_array:
                ...
                while is_array:
                    ...
                    if None == obj:
                        self.info(
                            "Encode-Array",
                            "made a new object at start (root index) @ {0}".format(
                                len(hash_map)
                            ),
                        )
                        ...
                        for index in range(len(hash_map) - 1, -1, -1):
                            if hash_map[index]["indent"] == indent and isinstance(
                                hash_map[index]["obj"], list
                            ):
...
class factory_json:
    ...
    def render(self, obj, depth=0):
        ...
        if isinstance(obj, str):
            ...
            for item in obj:
                partial.append(
                    tuple_template.format(item, self.render(obj[item], depth=depth + 1))
                )
            if len(partial) > 0:
...
class ddbPrompt(Cmd):
    ...
    def set_vars(self, config_file=None, debug=False, no_clip=False, width="auto"):
        if debug is None:
            debug = False
        self.debug = debug
    ...
    def msg(self, type, name, message=""):
        ...
        print(
            "{2}>>>{3} {4}{0}{3} {1}".format(
                name, message, bcolors.OKBLUE, bcolors.ENDC, color
            )
        )
    ...
    def default(self, inp):
        ...
        try:
            ...
            o = output_factory(
                results,
                output=self.engine.system["OUTPUT_MODULE"],
                output_style=self.engine.system["OUTPUT_STYLE"],
            )
            inp = None
        except Exception as ex:
            self.msg("error", ex)
...
def cli_main():
    parser = argparse.ArgumentParser(
        ...
        description="""flat file database access
                    """,
    ...
    if len(args.query) != 0 or not sys.stdin.isatty():
        ...
        if results.success == True:
            output_factory(
                results,
                output=e.system["OUTPUT_MODULE"],
                output_style=e.system["OUTPUT_STYLE"],
                output_file=None,
            )
        else:
            output_factory(
        ...
        prompt = ddbPrompt()
        prompt.set_vars(config_file=config_file, debug=False)
