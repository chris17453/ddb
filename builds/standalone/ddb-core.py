...
class update:
    ...
    def __init__(self,so):
            ...
            if gv(so,['meta','update','set']):
                self.set                 =[]
                for item in gv(item,['expression']):
